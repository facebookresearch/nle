...
def act(
    ...
    try:
        ...
        gym_env = create_env(
            flags.env, savedir=flags.rundir, env_id=actor_index, timeout_ms=-1
        )
...
def train(flags):  # pylint: disable=too-many-branches, too-many-statements
    ...
    env = create_env(flags.env, use_archivefile=False)
...
def test(flags, num_episodes=10):
    ...
    gym_env = create_env(flags.env, use_archivefile=False)
    env = ResettingEnvironment(gym_env)
