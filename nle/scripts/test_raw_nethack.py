...
NOTE: NLE users, please run `python -m nle.scripts.play --help` instead.
"""
import random
import timeit
    ...
    while True:
        ...
        if done:
            if last_observation.ProgramState().Gameover():
                ...
                if killer_name:
                    killer_name = killer_name.decode("utf-8")
            return steps
...
def main():
    ...
    game = nethack.NetHack(archivefile="random.zip", timeout_ms=1000)
